...
if(isset($_GET['type']) && $_GET['type']=='delete' && isset($_GET['id'])){ // suprimer le congé 
	$id=mysqli_real_escape_string($con,$_GET['id']);                                                      //créer une chaîne SQL légale que vous pouvez utiliser dans une instruction SQL
