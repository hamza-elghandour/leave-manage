                        ...
                        <div class="card-body card-block">
                           <form method="post" style="margin-left: 500px">
							   <div class="form-group">
								...
								<input type="text" value="<?php echo $department?>" name="department" placeholder="Enter your department name" class="form-control" required style="width:500px"></div>
							   
							   <button  type="submit" class="btn btn-lg btn-info btn-block" style="width:200px;margin-left:150px">
